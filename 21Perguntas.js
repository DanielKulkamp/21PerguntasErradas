...
var catalogo = {
	...
	"NOV": [
		...
		new Pergunta("Idade", "Consumo de castanha do pará", "Qual representa um fator de risco para o câncer de próstata?"),
		new Pergunta("Religião", "Nacionalidade", "Qual não representa um fator de risco para o câncer de próstata?"),
		new Pergunta("Falso", "Verdadeiro", "A obesidade não é fator de risco incerto para o câncer de próstata?"),
		new Pergunta("Sim", "Não", "O tabagismo é considerado um fator de risco incerto para câncer de próstata?"),
